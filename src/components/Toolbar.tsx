...
export const Toolbar: React.FC = () => {
  ...
  return (
    <div className="border-b px-4 py-3" style={{ backgroundColor: 'var(--bg-primary, #ffffff)', borderColor: 'var(--border-primary, #e5e7eb)' }}>
      <div className="flex items-center justify-center">
        <div className="flex items-center rounded-lg p-1 shadow-md border" style={{ backgroundColor: 'var(--bg-secondary, #f9fafb)', borderColor: 'var(--border-primary, #e5e7eb)' }}>
          {/* Lock/Unlock toggle */}
          <div className="flex items-center mr-2 pr-2 border-r" style={{ borderColor: 'var(--border-primary, #e5e7eb)' }}>
            <button
